        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-8">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col md:flex-row gap-3 items-start md:items-center">
              ...
              <input
                ...
                className="hidden"
              />
              <span className="text-sm text-gray-500">{moduleFileName}</span>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              disabled={loading}
              className="bg-[#0066ff] hover:bg-[#0052cc] text-white px-8 py-3 rounded-xl font-semibold shadow-md transition disabled:opacity-50"
            >
              {loading ? "Menyimpan..." : "SEND PROJECT"}
            </button>
          </div>
        </div>
      </div>
